...
public class StandingsService : IStandingsService
{
    ...
    public async Task<object> GetStandingsAsync(int tournamentId)
    {
        ...
        var standings = tournamentTeams.Select(tt =>
        {
            ...
            //que cumplen una condición especifica.
            //En este caso, se cuenta cuantos partidos como local (homeMatches)
            //resultaron en una victoria para el equipo, es decir,
            //cuantos partidos tuvieron mas goles a favor (HomeGoals) que en contra (AwayGoals).
